...
#define PCLK_DIV	3 //PCLK分频系数 该系数需与FPGA工程例化CM3时的PCLK_DIV参数一致

/**
  *
  * @brief: 复位指定的APB总线外设。
  *
  * @param: Periph,需要进行复位的APB总线外设；
  * 			可设置的值包括：RCC_APBPeriph_TIM0; RCC_APBPeriph_TIM1;
  *				RCC_APBPeriph_DTIMER0; RCC_APBPeriph_UART0 - UART0; RCC_APBPeriph_UART1;
  *				RCC_APBPeriph_I2C; RCC_APBPeriph_ADC; RCC_APBPeriph_Wdog;
  *				RCC_APBPeriph_SPI0; RCC_APBPeriph_SPI1.
  *					
