...
/**
  ...
  *
  * @param: TIMERx,使用哪个定时器，CM3DS_MPS2_TIMER0或CM3DS_MPS2_TIMER1。
  * 
  * @retVal: void
  */
...
/**
  ...
  *
  * @param: TIMERx,使用哪个定时器，CM3DS_MPS2_TIMER0或CM3DS_MPS2_TIMER1。
  * @param: TIM_InitStruct,定时器设置参数结构体，该结构体成员变量包括初始加载值和重新加载值。
  * @retVal: void
  */
...
/**
  ...
  * @brief: 清除定时器中断标志。
  *
  * @param: TIMERx,使用哪个定时器CM3DS_MPS2_TIMER0或CM3DS_MPS2_TIMER1。
  * 
  * @retVal: void
  */
