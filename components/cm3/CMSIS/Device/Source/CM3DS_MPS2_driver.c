 ...
 */
 ...
 {
       CM3DS_MPS2_GPIO->BYTE0_MASKED[0x000000FF & mask] = value;
       CM3DS_MPS2_GPIO->BYTE1_MASKED[((0x0000FF00 & mask) >> 8)] = value;
       CM3DS_MPS2_GPIO->BYTE2_MASKED[((0x00FF0000 & mask) >> 16)] = value;
       CM3DS_MPS2_GPIO->BYTE3_MASKED[((0xFF000000 & mask) >> 24)] = value;
 }
